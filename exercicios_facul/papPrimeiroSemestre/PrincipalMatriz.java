...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void determinanteMatriz(){
		...
		int ordem = 0, minuendo, subtraendo;
		int[][] m;
		...
		while ( ordem < 1 || ordem > 3 ){
			...
			if ( ordem < 1 || ordem > 3 ){
				System.out.println();
				System.out.println("A matriz deve estar entre as ordens 1 e 3!");
			}
		}
		m = new int[ordem][];
		...
		if ( m.length == 1 ) {
			...
			minuendo   = m[0][0] * m[1][1];
			subtraendo = m[0][1] * m[1][0];
		} else if ( m.length == 3 ) {
		...
		System.out.println();
		System.out.println("Eh " + (minuendo-subtraendo));
